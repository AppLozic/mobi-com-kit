(function ($) {
    ...
    $.fn.mobicomkit.defaults = default_options;
    ...
    function MobiComKit() {
        ...
        function MckMessageService() {
            ...
            _this.loadMessageList = function loadMessageList(userId) {
                ...
                if (typeof userId !== "undefined") {
                    ...
                    $mck_conversation_title.html('<a href="#" role="link" class="mck-conversation-tab-link"><img src="' + MCK_BASE_URL + '/resources/sidebox/images/ic_action_backward.png" alt="Back"></a>&nbsp ' + userId);
                } else {
                    individual = false;
                    pageSize = 50;
        ...
        function MckMessageLayout() {
            ...
            var markup = '<div name="message" data-msgdelivered="${msgDeliveredExpr}" data-msgsent="${msgSentExpr}" data-msgtype="${msgTypeExpr}"  data-msgtime="${msgCreatedAtTime}" data-msgcontent="${replyIdExpr}" data-msgkeystring="${msgKeyExpr}" data-contact="${contactIdsExpr}" class="row-fluid mck-m-b ${msgKeyExpr}"><div class="clear"><div class="blk-lg-12"><div class="${msgFloatExpr} mck-msg-box ${msgClassExpr}">' +
                    ...
                    '</div></div>';
            var contactbox = '<li id="li-${contIdExpr}" class="${contNameExpr}" data-msg-time="${msgCreatedAtTimeExpr}">' +
            ...
            _this.updateRecentConversationList = function (contact, msg, update) {
            ...
            _this.updateContact = function (contact, msg) {
        ...
        function MckFileService() {
            ...
            _this.getFilePreviewPath = function (fileMetaKeyString, fileName) {
